...
class CategoryRepositoryImpl : CategoryRepository {
    ...
    private val categoriesList = listOf(
        ...
        Category(id = "4", name = "Mobile Development", description = "Books about Android and mobile applications"),
        Category(id = "5", name = "Artificial Intelligence", description = "Books about AI and machine learning")
    )
